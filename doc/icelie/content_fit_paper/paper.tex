...
\begin{figure}[!h]
    \centering
    \vspace{-1em}
    \subfloat[Arrow 3-split]{\includegraphics[width=0.45\linewidth,trim={0 0 0 30pt},clip]{arrowsplit.jpg}}
    \hfill
...
\begin{figure}[htbp]
    \centering
    \subfloat[Direction from max-distance keypoints]{\includegraphics[width=0.45\linewidth]{arrow_double_clustering_direction.png}}
    \hfill
    \subfloat[Self-arrow: extremities miss actual head/tail]{\includegraphics[width=0.45\linewidth]{selfarrowdc.jpg}}
