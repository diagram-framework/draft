...
Currently, the release is best understood as a reproducible software prototype rather than a fully packaged benchmark distribution. In addition to source code, the project provides pretrained model weights through a public weights folder\footnote{\scriptsize\url{https://drive.google.com/drive/folders/1OiFMgyGBnd7mLpTMaKXvobQ5-njjW7fp?usp=share_link}} linked from the repository README, making it possible to run the end-to-end pipeline without retraining from scratch. Users are expected to install external tooling and in some cases adjust extraction thresholds to match their diagram style. Instructors and researchers can adapt the workflow to local assignments, substitute alternative OCR or detection models, and compare generated outputs without rebuilding the full stack from scratch.
