...
% Eviterei l'autogol di "non è un sota"
...
% Un po' più di dettaglio sui moduli
...
% Anche questa sezione è molto povera, sembra più una supercazzola che una spiegazione tecnica
...
% Mancano i dettagli sul finetuning e sui dataset
% Mancano i dettagli sul modello usato per OCR (e.g. la size)
...
% Le ultime due sezioni sono troppo lunghe e vaghe, non abbiamo messo dettagli e poi gli raccontiamo le favole
